...
// // Link to GeoJSON
// var APILink = "Census_Tracts_Income_per_Location.geojson"
...
//     valueProperty: "Income_per_location_Household Income by Race",
...
//       layer.bindPopup("<h1>" + feature.properties.statefp10 + "</h1></br>" + "<strong>Happiness Rank: </strong>" + feature.properties.final_seventeen_happiness_rank + "</h1></br>" + "<strong>Population: </strong>" + feature.properties.final_seventeen_population);
//     }
//   }).addTo(myMap);
